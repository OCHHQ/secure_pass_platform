...
import { deleteVaultById, updateVault } from "../api/api";
...
const Vaults = ({ userID = " ", listVaults = [], setVaultForm }) => {
    ...
    return (
        <>
            <div className="flex flex-col justify-center border-red-50 border-2 ">
                                ...
                                {Vaults.map((vault) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-row md:flex-row md:justify-around md:gap-4 justify-center gap-2">
                                            <button className="w-1/2 bg-blue-500 text-white p-2 rounded-lg text-xs md:text-sm lg:text-base"
                                            ...
                                            <button className="w-1/2 bg-indigo-600 text-white p-2 rounded-lg text-xs md:text-sm lg:text-base">
                                                Share
                                            </button>
                                        </div>
                                    </div>
            ...
            {vaultEdit && (
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <form className="bg-white p-8 font-semibold text-xl rounded-lg shadow-xl ">
                        ...
                        <input type="text" name="username" id="username" value={vault?.username || ''} onChange={(e) => setVault({ ...vault, username: e.target.value })}/>
                        <label htmlFor="password" className="p-4">Password:</label>
                        <input type="text" name="password" id="password" value={vault?.password || ''} onChange={(e) => setVault({ ...vault, password: e.target.value })} />
                        <div className="flex  gap-2 mt-4">
                            <button
