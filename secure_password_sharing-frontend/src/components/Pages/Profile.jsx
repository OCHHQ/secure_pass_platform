...
function Profile() {
    ...
    return (
        <>
            <Header />
            <div className="flex flex-col md:flex-row bg-[#F9F6F3]">
                <Sidebar />
                <div id='Profile' className='flex-1 pt-20 px-4 lg:px-8'>
                    <div className='h-full rounded-tl-3xl shadow-2xl p-4 lg:p-8 bg-[#F9F6F3]'>
                        {isLoading ? (
                            ...
                            <div className='flex flex-col gap-4 m-4 lg:m-10'>
                                ...
                                <div className="flex flex-col gap-4 shadow-2xl p-4 lg:p-8 bg-[#F9F6F3] rounded-3xl">
                                ...
                                <button className="bg-blue-500 hover:bg-blue-700 text-xl text-white font-bold py-2 px-4 rounded-full w-full lg:w-1/2 self-center mt-10" onClick={() => setEdit(true)}>Edit</button>
                            </div>
                        ))}
                    </div>
                </div>
